...
class JobSearchForm(forms.Form):
    ...
    insertedDateStart = forms.DateField(label='After Inserted Date', required=False)
    postedDateStart = forms.DateField(label='After Posted Date', required=False)
    postedDateEnd = forms.DateField(label='Before Posted Date', required=False)
